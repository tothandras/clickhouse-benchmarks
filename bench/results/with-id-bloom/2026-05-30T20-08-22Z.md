...
| Concurrency | 1 |
| Started | 2026-05-30T20:08:22Z |
| Finished | 2026-05-30T20:10:17Z |

## Ingest

Source `go-seeder`: 10000000 rows in 114.04s (87692 events/sec), batch=10000.

## Queries

| Query | p50 ms | p95 ms | p99 ms | QPS | CPU p50 ms | CPU src | Mem MB |
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| lookup_by_id | 34.0 | 62.0 | 62.0 | 19.0 | 220.5 | os_cpu | 372.7 |
