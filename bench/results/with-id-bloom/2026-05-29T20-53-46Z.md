...
| Concurrency | 1 |
| Started | 2026-05-29T20:53:46Z |
| Finished | 2026-05-29T20:53:48Z |

## Ingest

Source `go-seeder`: 200000 rows in 2.16s (92440 events/sec), batch=10000.

## Queries

| Query | p50 ms | p95 ms | p99 ms | QPS | CPU p50 ms | CPU src | Mem MB |
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| lookup_by_id | 20.0 | 28.0 | 28.0 | 23.2 | 28.2 | os_cpu | 16.7 |
