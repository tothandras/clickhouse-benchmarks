# cogs-query-mix Specification

## Purpose

Define the per-scenario query-mix manifest: weighted classes over the scenario's on-disk queries with explicit excludes for diagnostics, strict validation that forces conscious classification, and a placeholder-weights caveat carried into every report.
